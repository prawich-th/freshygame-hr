  ...
  return <section className="content-card" style={{marginBottom:16}}>
    ...
    {rows && <section aria-labelledby="selection-title">
      ...
      <div style={{padding:24}}>
        ...
        <div className="notice notice--info">This selection covers {sport} only. A person can be kept in one sport even if they are not selected in another. Their other sport registrations will stay untouched. Checked participants will stay. Unchecked registrations will be permanently removed with their upload sessions. Documents used by another registration are retained. Audit history is retained.</div>
        {stage === "select" ? <>
