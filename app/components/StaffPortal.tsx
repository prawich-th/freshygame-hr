  ...
  async function handleFile(file?: File) {
    ...
    try {
      ...
      const mapped = rows.map((row, index) => {
        ...
        if (!["คณะแพทยศาสตร์", "คณะศิลปศาสตร์", "คณะแพทยศาสตร์นานาชาติจุฬาภรณ์"].includes(p.faculty)) throw new UserFacingError(`Row ${index + 2}: Faculty is not supported. Use the Thai faculty name shown in the participant form.`);
